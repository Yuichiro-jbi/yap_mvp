...
String _$navigationServiceHash() => r'0720a87800745544e9ddff40fbe32f63eef4c58d';

/// See also [NavigationService].
@ProviderFor(NavigationService)
final navigationServiceProvider =
    AutoDisposeNotifierProvider<NavigationService, void>.internal(
...
typedef _$NavigationService = AutoDisposeNotifier<void>;
